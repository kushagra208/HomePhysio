  ...
  return (
    <View style={{display: 'flex'}}>
        ...
        <View style={styles.calendar}>
            {data[week].map((el,i) => (
                <View key={i} style={{display: 'flex', flexDirection: 'row', gap: 2, marginBottom: 4 , width: '100%', justifyContent:'space-between', }}>
                    ...
                    <View style={{ display: 'flex', flexWrap: 'wrap', alignItems:'center', flexDirection: 'row', width: 40, height: 40, gap:2 , backgroundColor: 'white', borderRadius: 2}}>
                        {typeof(el.Mon) === 'object' ? el.Mon.map((el2)=>(
                            <View style={{width: 18, height: 18, display: 'flex' , alignItems: 'center', justifyContent: 'center'}}><Text style={{fontSize: 8}}>{el2}</Text></View>
                    ...
                    <View style={{ display: 'flex', flexWrap: 'wrap', alignItems:'center', flexDirection: 'row', width: 40, height: 40, gap:2 , backgroundColor: 'white', borderRadius: 2}}>
                        {typeof(el.Tue) === 'object' ? el.Tue.map((el2)=>(
                            <View style={{width: 18, height: 18, display: 'flex' , alignItems: 'center', justifyContent: 'center'}}><Text style={{fontSize: 8}}>{el2}</Text></View>
                    ...
                    <View style={{ display: 'flex', flexWrap: 'wrap', alignItems:'center', flexDirection: 'row', width: 40, height: 40, gap:2 , backgroundColor: 'white', borderRadius: 2}}>
                        {typeof(el.Wed) === 'object' ? el.Wed.map((el2)=>(
                            <View style={{width: 18, height: 18, display: 'flex' , alignItems: 'center', justifyContent: 'center'}}><Text style={{fontSize: 8}}>{el2}</Text></View>
                    ...
                    <View style={{ display: 'flex', flexWrap: 'wrap', alignItems:'center', flexDirection: 'row', width: 40, height: 40, gap:2 , backgroundColor: 'white', borderRadius: 2}}>
                        {typeof(el.Thurs) === 'object' ? el.Thurs.map((el2)=>(
                            <View style={{width: 18, height: 18, display: 'flex' , alignItems: 'center', justifyContent: 'center'}}><Text style={{fontSize: 8}}>{el2}</Text></View>
                    ...
                    <View style={{ display: 'flex', flexWrap: 'wrap', alignItems:'center', flexDirection: 'row', width: 40, height: 40, gap:2 , backgroundColor: 'white', borderRadius: 2}}>
                        {typeof(el.Fri) === 'object' ? el.Fri.map((el2)=>(
                            <View style={{width: 18, height: 18, display: 'flex' , alignItems: 'center', justifyContent: 'center'}}><Text style={{fontSize: 8}}>{el2}</Text></View>
                    ...
                    <View style={{ display: 'flex', flexWrap: 'wrap', alignItems:'center', flexDirection: 'row', width: 40, height: 40, gap:2 , backgroundColor: 'white', borderRadius: 2}}>
                        {typeof(el.Sat) === 'object' ? el.Sat.map((el2)=>(
                            <View style={{width: 18, height: 18, display: 'flex' , alignItems: 'center', justifyContent: 'center'}}><Text style={{fontSize: 8}}>{el2}</Text></View>
                    ...
                    <View style={{ display: 'flex', flexWrap: 'wrap', alignItems:'center', flexDirection: 'row', width: 40, height: 40, gap:2 , backgroundColor: 'white', borderRadius: 2}}>
                        {typeof(el.Sun) === 'object' ? el.Sun.map((el2)=>(
                            <View style={{width: 18, height: 18, display: 'flex' , alignItems: 'center', justifyContent: 'center'}}><Text style={{fontSize: 8}}>{el2}</Text></View>
